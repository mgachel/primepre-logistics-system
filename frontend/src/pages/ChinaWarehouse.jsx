...
const ChinaWarehouse = () => {
  ...
  const handleEditItem = async (id, itemData) => {
    try {
      ...
      await goodsService.updateChinaGoods(id, itemData);
  ...
  const handleDelete = async (id) => {
    if (window.confirm('Are you sure you want to delete this item?')) {
      try {
        await goodsService.deleteChinaGoods(id);
        await loadGoods();
      } catch (err) {
    ...
    <DashboardLayout title="China Warehouse">
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
          <div>
            <h2 className="text-2xl font-bold text-gray-900">China Warehouse Management</h2>
            <p className="mt-1 text-sm text-gray-500">
              Track and manage goods received in Chinese warehouses
            </p>
          </div>
        ...
        <StatsDashboard warehouse="china" />
          ...
          <div className="text-center py-12 bg-white rounded-lg shadow">
            <div className="max-w-md mx-auto">
              ...
              <p className="text-gray-500 mb-6">
                Get started by adding goods to your China warehouse or adjust your search filters.
              </p>
