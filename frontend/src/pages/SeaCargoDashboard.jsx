...
const SeaCargoDashboard = () => {
  ...
  const fetchSeaContainers = async () => {
    try {
      setLoading(true);
      const data = await cargoService.getSeaContainers();
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="mt-2 text-gray-600">Manage sea freight containers and shipments</p>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 mb-8">
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-600">Total Sea Containers</p>
                <p className="text-3xl font-bold text-gray-900">{stats.total}</p>
              </div>
              <div className="bg-teal-500 p-3 rounded-full text-white text-2xl">
                🚢
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200">
            <div className="px-6 py-4 border-b border-gray-200">
              <h2 className="text-xl font-semibold text-gray-900">
                Sea Cargo Containers ({filteredContainers.length})
              </h2>
            </div>
            <div className="overflow-x-auto">
              ...
              {filteredContainers.length === 0 && (
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-500 text-lg">No sea cargo containers found</p>
        ...
        <div className="mt-8 bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <button
              onClick={() => navigate('/cargo/containers?cargo_type=sea&status=demurrage')}
              className="bg-red-50 border border-red-200 rounded-lg p-4 text-left hover:bg-red-100 transition-colors"
            >
              <div className="flex items-center">
                <span className="text-2xl mr-3">⚠️</span>
                <div>
                  <div className="font-semibold text-red-800">Demurrage Containers</div>
                  <div className="text-sm text-red-600">View containers with demurrage charges</div>
                </div>
              </div>
            </button>
            
            <button
              onClick={() => navigate('/cargo/containers?cargo_type=sea&status=in_transit')}
            ...
            >
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <div className="text-sm text-yellow-600">Track containers currently shipping</div>
                </div>
              </div>
            </button>
            
            <button
              onClick={() => navigate('/cargo/containers?show_create=true&cargo_type=sea')}
              className="bg-teal-50 border border-teal-200 rounded-lg p-4 text-left hover:bg-teal-100 transition-colors"
            >
              <div className="flex items-center">
                <span className="text-2xl mr-3">➕</span>
                <div>
                  <div className="font-semibold text-teal-800">Add Sea Container</div>
                  <div className="text-sm text-teal-600">Register new sea freight container</div>
                </div>
              </div>
            </button>
          </div>
...
export default SeaCargoDashboard;
