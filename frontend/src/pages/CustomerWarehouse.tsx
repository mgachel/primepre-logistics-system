...
export default function CustomerWarehouseSea() {
    ...
    const load = async () => {
      ...
      try {
        ...
        const [listRes, dashRes] = await Promise.all([
          goodsReceivedContainerService.getCustomerGhanaSeaContainers({
            search: searchTerm || undefined,
            status: statusParam,
            page_size: 100,
          }),
          goodsReceivedContainerService.getCustomerGhanaSeaStatistics(),
        ]);
  ...
  const reloadData = async () => {
    ...
    try {
      ...
      const [listRes, dashRes] = await Promise.all([
        goodsReceivedContainerService.getCustomerGhanaSeaContainers(filters),
        goodsReceivedContainerService.getCustomerGhanaSeaStatistics(),
      ]);
  ...
  const handleRowClick = (row: GoodsReceivedContainer) => {
    navigate(`/customer/warehouse/sea/container/${row.container_id}`);
  };
  ...
  const columns: Column<GoodsReceivedContainer>[] = [
    {
      ...
      header: "Container ID",
      accessor: (row) => (
        <div className="font-mono font-medium text-blue-600">{row.container_id}</div>
      ),
    ...
    },
    {
      ...
      accessor: (_row) => (
        <div className="text-sm">
          ...
          <div className="text-xs text-muted-foreground">Sea Freight</div>
        </div>
      ),
      width: "140px",
    },
    ...
    <div className="logistics-container">
      ...
      <div className="logistics-header">
        <div className="logistics-title-section">
          ...
          <div>
            <h1 className="logistics-title">Local Warehouse - Sea</h1>
            <p className="logistics-subtitle">
              View your sea cargo containers and goods in Ghana warehouse
            </p>
          </div>
        </div>
      ...
      {/* Data Table */}
      <DataTable
        id="customer-warehouse-containers"
          ...
          <div className="text-center py-8">
            ...
            <p className="text-muted-foreground">
              {searchTerm
                ...
                : "No containers with your goods available yet"}
            </p>
          </div>
        }
      />
