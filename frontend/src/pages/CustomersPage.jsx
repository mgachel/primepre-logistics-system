        ...
        <div className="bg-white rounded-lg shadow-sm p-6 md:p-8">
          <div className="flex justify-center items-center h-48 md:h-64">
            <div className="text-center">
              ...
              <div className="text-base md:text-lg text-gray-600">Loading customers...</div>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 md:p-8">
          <div className="flex justify-center items-center h-48 md:h-64">
            <div className="text-center">
              ...
              <div className="text-base md:text-lg text-gray-900 mb-2">Error Loading Customers</div>
              <div className="text-sm md:text-base text-gray-600 mb-4">{error}</div>
              <button
        ...
        <div className="w-full">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
            ...
            <div className="bg-gradient-to-r from-blue-50 to-blue-100 rounded-xl p-4 md:p-6 border border-blue-200">
              <div className="flex items-center justify-between">
                <div className="flex-1">
                  <div className="text-xs md:text-sm text-blue-600 font-medium mb-1">Total Customers</div>
                  <div className="text-xl md:text-2xl lg:text-3xl font-bold text-blue-900">{customerStats.customer_users?.toLocaleString() || '0'}</div>
                  <div className="text-xs md:text-sm text-green-600 font-medium mt-1">↑ 16% this month</div>
                </div>
            ...
            <div className="bg-gradient-to-r from-green-50 to-green-100 rounded-xl p-4 md:p-6 border border-green-200">
              <div className="flex items-center justify-between">
                <div className="flex-1">
                  <div className="text-xs md:text-sm text-green-600 font-medium mb-1">Active Customers</div>
                  <div className="text-xl md:text-2xl lg:text-3xl font-bold text-green-900">{customerStats.active_users?.toLocaleString() || '0'}</div>
                  <div className="text-xs md:text-sm text-green-600 font-medium mt-1">↑ 8% this month</div>
                </div>
            ...
            <div className="bg-gradient-to-r from-red-50 to-red-100 rounded-xl p-4 md:p-6 border border-red-200 sm:col-span-2 lg:col-span-1">
              <div className="flex items-center justify-between">
                <div className="flex-1">
                  <div className="text-xs md:text-sm text-red-600 font-medium mb-1">Inactive Customers</div>
                  <div className="text-xl md:text-2xl lg:text-3xl font-bold text-red-900">{((customerStats.customer_users || 0) - (customerStats.active_users || 0)).toLocaleString()}</div>
                  <div className="text-xs md:text-sm text-red-600 font-medium mt-1">↓ 2% this month</div>
                </div>
      ...
      <div className="bg-white rounded-lg shadow-sm overflow-hidden">
        <div className="p-4 md:p-6 border-b border-gray-200">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            <div className="flex-1">
              <h2 className="text-lg md:text-xl font-semibold text-gray-900">ALL CLIENTS</h2>
                ...
                <div key={customer.id} className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                  <div className="flex items-start justify-between mb-3">
                    <div className="flex items-center space-x-3">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-gray-500">{customer.shipping_mark || `SM${customer.id.toString().padStart(3, '0')}`}</p>
                      </div>
                    </div>
                  ...
                  <div className="grid grid-cols-1 gap-2 text-sm">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="text-gray-900">{customer.region || 'N/A'}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-500">Created by:</span>
                      <span className="text-gray-900">{customer.created_by?.full_name || customer.created_by?.first_name || 'System'}</span>
                    </div>
                  </div>
          ...
          <table className="w-full min-w-full">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="px-4 xl:px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Shipping Mark</th>
                <th className="px-4 xl:px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Client Name</th>
                <th className="px-4 xl:px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Email Address</th>
                <th className="px-4 xl:px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Phone</th>
                <th className="px-4 xl:px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Region</th>
                <th className="px-4 xl:px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Status</th>
                <th className="px-4 xl:px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Created By</th>
