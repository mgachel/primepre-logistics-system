...
const EditItemModal = ({ isOpen, onClose, onSubmit, warehouse, loading = false, item = null }) => {
  ...
  useEffect(() => {
    if (item) {
      setFormData({
        ...
        location: item.location || (warehouse === 'china' ? 'GUANGZHOU' : 'ACCRA'),
  ...
  const statusOptions = warehouse === 'china'
    ? [
        ...
        <div className="relative bg-white rounded-lg shadow-xl w-full max-w-2xl">
          ...
          <div className="flex items-center justify-between p-6 border-b border-gray-200">
            <h3 className="text-lg font-semibold text-gray-900">
              Edit Item - {warehouse === 'china' ? 'China' : 'Ghana'} Warehouse
            </h3>
            <button
              onClick={handleClose}
